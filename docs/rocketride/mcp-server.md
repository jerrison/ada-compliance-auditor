...
```
{  "mcpServers": {    "rocketride": {      "command": "rocketride-mcp"    }  }}
```
...
```
export ROCKETRIDE_URI=https://your-engine.example.comexport ROCKETRIDE_APIKEY=your-api-key
```
...
```
{  "mcpServers": {    "rocketride": {      "command": "python",      "args": ["-m", "rocketride_mcp"]    }  }}
```
...
```
# Using the installed entry pointrocketride-mcp# Or using Python modulepython -m rocketride_mcp
```
